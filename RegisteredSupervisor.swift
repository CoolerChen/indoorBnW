//
//  RegisteredSupervisor.swift
//  indoorB&W2
//
//  Created by Bing on 2016/2/29.
...
class RegisteredSupervisor: UIViewController,UITextFieldDelegate,NSURLSessionDownloadDelegate {
    ...
    override func viewDidLoad() {
        ...
        let textFieldtext:[String] = ["帳號","密碼","信箱","手機","地址"]
        ...
        //註冊
        self.view.addSubview(Sup.addBtn(self, frame: CGRectMake(self.view.frame.size.width/2-textFieldW/2, 360, textFieldW, textFieldH), str: "商家註冊", tag: 0))
    ...
    func URLSession(session: NSURLSession, downloadTask: NSURLSessionDownloadTask, didFinishDownloadingToURL location: NSURL) {
        ...
        if resp! == "帳號重複"{
            ...
            Sup.Supervisor.supervisor = textFieldAry[0].text!
            for var i = 0 ; i < textFieldAry.count ;i++ {
                textFieldAry[i].text = ""
            }
    ...
    func textField(textField: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        ...
        }else if textField == textFieldAry[3]{
